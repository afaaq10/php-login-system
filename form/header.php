...
<a class="navbar-brand" href="in.php">iDiscuss</a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
      ...
      $sql = "SELECT category, id FROM `user2` LIMIT 3";
      $result = mysqli_query($conn, $sql); 
      while($row = mysqli_fetch_assoc($result)){
        echo '<a class="dropdown-item" href="threadlist.php?catid='. $row['id']. '">' . $row['category']. '</a>'; 
      }        
      echo '</div>
    </li>
    <li class="nav-item">
